def PV_generated_power(self,cell_area:int=1, panel_count:int=1, T_STC:int=25, V_OC_STC:int=0.6, delta_V_OC:int=-0.025, I_sc_a:int=300, FF:int=0.8, T_cell:int=30, irradiance_STC:int=100, irradiance_a:int=120):
        """
