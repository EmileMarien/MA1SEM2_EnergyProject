...
def electricity_cost(solar_panel_count: int=1, panel_surface:int= 2,annual_degradation: float=0.004, panel_efficiency: int= 0.2253, temperature_coefficient: float=-0.0026, inverter_size_AC: int = 3, inverter_maxsolar_DC: int = 8, inverter_maxbattery_DC: int=5,tilt_angle:int=-1, Orientation:str="S", battery_capacity: float= 8, battery_count: int=0,tariff: str='DualTariff',add_EV:bool=True):
    """
