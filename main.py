...
#with formatter:
#print(irradiance.get_dataset())
powercalculations_test = pc.PowerCalculations(file_path_irradiance='data/Irradiance_data_vtest.xlsx',file_path_load='data/Load_profile_6_vtest.xlsx')
print(powercalculations_test.get_dataset())
powercalculations_test.interpolate_columns()
powercalculations_test.filter_data_by_date_interval(start_date="2018-1-24 08:30",end_date="2018-1-30 08:30",interval_str="1h")
...
with formatter:
    ...
    print(powercalculations_test.get_direct_irradiance())
